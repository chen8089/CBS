...
import getRecentActivities from '@salesforce/apex/RecentActivityReportController.getRecentActivities';

export default class RecentActivityReport extends NavigationMixin(LightningElement) {
    @api maxItems = 20;
