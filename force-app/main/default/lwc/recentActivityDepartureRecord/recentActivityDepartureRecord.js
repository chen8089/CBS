...
import getRecentActivitiesByRecordId from '@salesforce/apex/RecentActivityDepartureController.getRecentActivitiesByRecordId';

export default class RecentActivityDepartureRecord extends NavigationMixin(LightningElement) {
    @api recordId;
    @api contactId;
    @api maxItems = 20;
