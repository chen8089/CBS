...
import getRecentActivitiesByRecordId from '@salesforce/apex/RecentActivityContactController.getRecentActivitiesByRecordId';

export default class RecentActivityContactRecord extends NavigationMixin(LightningElement) {
    @api recordId;
    @api contactId;
    @api maxItems = 20;
    ...
    handleViewClick(event) {
        ...
        this[NavigationMixin.Navigate]({
            ...
            attributes: {
                recordId: this.effectiveContactId,
