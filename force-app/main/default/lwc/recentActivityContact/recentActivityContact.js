...
import getRecentActivities from '@salesforce/apex/RecentActivityContactController.getRecentActivities';

export default class RecentActivityContact extends NavigationMixin(LightningElement) {
    @api maxItems = 20;
    @api trackedFieldApiName;
    @api trackedFieldLabel;
